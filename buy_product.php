<?php
   ...
   if(isset($_POST['add_to_cart'])){
      ...
      $cart_query = mysqli_query($dbc,"SELECT * FROM `cart` WHERE pname = '$pname'");

      if(mysqli_num_rows($cart_query) < 0){
         $insert_cart_query = mysqli_query($dbc,"INSERT INTO `cart` (pname,pprice)VALUES('$pname','$pprice')");
      }
   }
?>
            ...
            <tbody>
                <?php
                    while($row = mysqli_fetch_array($results, MYSQLI_ASSOC)){
                        ...
                        $str_to_print .= "<td> <a href='add_to_cart.php?pid={$row['pid']}' style='color:crimson;' name='add_to_cart'>Add to Cart</a> </td> </tr>";
