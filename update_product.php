...
<div class="form-container2">
    ...
    $errors = [];
        ...
        if(!empty($_POST['pid'])){
            ...
            $pid = null;
            $errors[] = "<p>Please enter the Product ID!</p>";
        }
        ...
        if(!empty($_POST['pname'])){
            ...
            $pname = null;
            $errors[] = "<p>Please enter the Product Name!</p>";
        }
        ...
        if(!empty($_POST['pcompany'])){
            ...
            $pcompany = null;
            $errors[] = "<p>Please enter the Product Company Name!</p>";
        }
        ...
        if(!empty($_POST['pprice'])){
            ...
            $pprice = null;
            $errors[] = "<p>Please enter the Product Price!</p>";
        }
        ...
        if(!empty($_POST['pquantity'])){
            ...
            $pquantity = null;
            $errors[] = "<p>Please enter the Product Quantity!</p>";
        }
        ...
        if(!empty($_POST['product_user'])){
            ...
            $product_user = null;
            $errors[] = "<p>Please select the Product's User!</p>";
        }
